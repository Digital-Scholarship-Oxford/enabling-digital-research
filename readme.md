...
This repository contains code and data from the project "Enabling digital research on manuscript catalogue data", funded by a Digital Scholarship @ Oxford (DiSc) Research Development Grant in 2025.

The main output is a set of tabular data, regularly updated, derived from _Medieval Manuscripts in Oxford Libaries_. Links to download the data in xsl, csv and json formats can be found in the user guide.
